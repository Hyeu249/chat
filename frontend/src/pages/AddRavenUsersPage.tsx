...
const CARD_STYLE =
  "p-4 shadow-accent-a2 shadow-lg dark:shadow-accent-a2 dark:shadow-md";

const RavenUsersAlert = () => {
  return (
    <Box className={clsx(BOX_STYLE, "bg-accent-a4")}>
        ...
        <Flex direction="column" align="center" gap="4">
          <Box py="1">
            <Flex
              align="center"
              justify="center"
              className="text-accent-11 bg-accent-a4 rounded-full p-4"
            >
              <FaInfo size={24} />
            </Flex>
          </Box>
          <Flex direction="column" align="center" gap="2">
            <Heading as="h2" className="not-cal" size="4">
              ...
              <Text className="cal-sans">LongYin-TALK</Text>.
            </Heading>
            <Text as="p" size="2" align="center" className="leading-6">
              Please contact your Administrator or System Manager to give you
              the <Strong>"Raven User"</Strong> role.
            </Text>
            <Flex gap="3" direction="column" py="1" pt="3">
              <Button asChild>
                <Link className="text-white" href={"/app/raven-user"}>
                  View Raven Users
                </Link>
              </Button>
              <Button
...
const AddRavenUsersCard = () => {
  ...
  const {
    ...
    nextPage,
    previousPage,
  } = usePaginationWithDoctype("User", 10, filters);
  ...
  const {
    ...
    call,
    error: postError,
  } = useFrappePostCall("raven.api.raven_users.add_users_to_raven");
  ...
  return (
    <Box className={clsx(BOX_STYLE, "bg-accent-a2")}>
